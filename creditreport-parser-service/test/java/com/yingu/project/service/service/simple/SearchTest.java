...
/**
 * @Date: Created in 2018/3/27 15:07
 * @Author: wm
 */
...
//    @After
    ...
    public void testFuzzyQuery()throws Exception{
        ...
        indexer.addDocument(searchField, "报告编号：");
        indexer.closeWriter();
        ...
        TopDocs hits=is.search(boostQuery, Integer.MAX_VALUE);
        System.out.println("匹配 '"+keyword+"'，总共查询到"+hits.totalHits+"个文档");
